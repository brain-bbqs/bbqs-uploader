...
export function getElements() {
  return {
    ...
    humanSubjectsBanner: required<HTMLDivElement>("human-subjects-banner"),
    humanSubjectsUnconfirmed: required<HTMLDivElement>("human-subjects-unconfirmed"),
    humanSubjectsConfirmBtn: required<HTMLButtonElement>("human-subjects-confirm-btn"),
    humanSubjectsConfirmed: required<HTMLParagraphElement>("human-subjects-confirmed"),
    ...
    folderCard: required<HTMLElement>("folder-card"),
    filesCard: required<HTMLElement>("files-card"),
    loadRemoteBtn: required<HTMLButtonElement>("load-remote-btn"),
    ...
    folderSummary: required<HTMLDivElement>("folder-summary"),
    folderSummaryName: required<HTMLSpanElement>("folder-summary-name"),
    folderSummaryStats: required<HTMLSpanElement>("folder-summary-stats"),
    changeFolderBtn: required<HTMLButtonElement>("change-folder-btn"),
    remoteBanner: required<HTMLDivElement>("remote-banner"),
    remoteBannerIcon: required<HTMLSpanElement>("remote-banner-icon"),
    remoteBannerTitle: required<HTMLDivElement>("remote-banner-title"),
    remoteBannerBody: required<HTMLDivElement>("remote-banner-body"),
    remoteRecheckBtn: required<HTMLButtonElement>("remote-recheck-btn"),
    selectionBar: required<HTMLDivElement>("selection-bar"),
    selectionSummary: required<HTMLSpanElement>("selection-summary"),
    selectAllBtn: required<HTMLButtonElement>("select-all-btn"),
    selectNoneBtn: required<HTMLButtonElement>("select-none-btn"),
    ignoreChips: required<HTMLSpanElement>("ignore-chips"),
    ignorePatternInput: required<HTMLInputElement>("ignore-pattern-input"),
