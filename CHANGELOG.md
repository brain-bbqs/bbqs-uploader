...
- Renamed the app to "BBQS Uploader" with the BBQS logo in the header, and added a subtitle ("Your direct upload link to the EMBER-DANDI Archive", 50% larger than initially) flanked by the EMBER logo on both sides ([#20](https://github.com/brain-bbqs/ember-uploader/pull/20))
